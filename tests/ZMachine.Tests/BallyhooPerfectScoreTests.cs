...
public class BallyhooPerfectScoreTests
{
    ...
    private static readonly string[] DuniganWalkthroughCommands =
    [
        ...
        "hit wood with pole",
        "take mousetrap",
        "east", "northeast", "north", "northeast",
        "search garbage",
        "take ticket",
        "punch blue",
        "southwest", "south",
        ...
        "get bucket",
        "get headphones",
        "south", "northwest", "north", "west", "southwest", "west",
        "drop mousetrap",
        "drop meat",
        "take meat",
        "east", "west",
        ...
        "pass $1.85 to hawker",
        "get up",
        "east", "up", "east", "down", "east", "up", "east", "down",
        "south",
        "get in line",
        "z", "z",
        "get out of long line",
        ...
        "rewind tape",
        "drop all but radio and headphones",
        "up",
        "turn radio to 1170",
        "record tape",
        "z",
        ...
        "northwest", "southwest", "west", "west",
        "go under wall",
        "east",
        "unlock compartment",
        "open compartment",
        "take whip",
        "north", "northeast", "north", "north",
        "unlock cage",
        "open cage",
        "west",
        "whip smooth lion",
        ...
        "south", "south", "south", "west",
        "give case to harry",
        "east", "northeast", "north", "east", "south",
        "show case to andrew",
        "show case to jenny",
        "up",
        "get all",
        ...
        "east",
        "eddie, hello",
        "show newsprint to eddie",
        "show spreadsheet to eddie",
        "show ribbon to eddie",
        "show note to eddie",
        "show card to eddie",
        "wear dress",
        "wear shawl",
    ...
    [SkippableFact]
    public void Ballyhoo_PerfectScore_Dunigan()
    {
        var path = Path.Combine(StoriesDir, "ballyhoo.z3");
        Skip.IfNot(File.Exists(path), "ballyhoo.z3 not found in stories/");
        ...
        try
        {
            harness = TestHarness.Run(path, DuniganWalkthroughCommands,
                instructionLimit: 2_000_000_000);
        }
        catch (ZMachineException ex)
        {
